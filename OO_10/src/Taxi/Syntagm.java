...
public class Syntagm {
	 ...
	 * 		path.equals("") || path.equals("Detail.txt") || path.equals("Request_"+ordernum+".txt")
	 * 10	ordernum>=0
	 * 11	findword为String型变量，且不为null
	 * 		findword.queals("") || findword.equals("Taxi") || findword.equals("Status")
	 * 12	-1<=findtaxi<=99
	 * 13	mark>=0
	 * 14	0<=status<=3
	 * */
	public boolean repOK(){
		...
		try{
			...
			|| value<-1 || value>6399
			|| !(path.equals("") || path.equals("Request_"+ordernum+".txt") || path.equals("Detail.txt"))
			|| !(findword.equals("")||findword.equals("Taxi")||findword.equals("Status"))
