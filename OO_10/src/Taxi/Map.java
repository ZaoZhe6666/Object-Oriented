...
public class Map {
	...
	public boolean repOK(){
		...
		try{
			if(ctrl==null || road==null || map_gui==null || road_map==null
	...
	Map(){
		/* @ REQUIRES:	Readin.MAX=80	this中各项非Null
		 * @ MODIFIES:	road[][]	road_map[][]	map_gui[][]	
		 * 				weight_map_old[][] 	weight_map_new[][]
		 * @ EFFECTS: 	初始化上述数组的大小，并且把road[][]将使用部分初始化为-1
		 */
	...
	public void addmap(int line,int list,int value){
		 ...
		 * 			&&	road!=null
		 * @ MODIFIES:road[][]
		 * @ EFFECTS: 增删地图操作，修改(line,list)所在位置的右侧连线和下方连线的属性
	...
	public int setmap(){
		/* @ REQUIRES: road!=null && road_map!=null &&　main.reset=false && Readin.MAX=80
...
//					return -1;
	...
	public void print_map(){
		/* @ REQUIRES: road_map!=null && Readin.MAX=80
		 * @ MODIFIES: none
		 * @ EFFECTS: 绘制我自创的静态地图
		 */
